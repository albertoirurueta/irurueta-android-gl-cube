...
android {
    namespace = "com.irurueta.android.gl.cube"
    compileSdk = 36
    ...
    defaultConfig {
        ...
        val apkPrefixLabels = listOf("glcube", libraryVersion, buildNumber)
...
sonar {
    properties {
        ...
        property("sonar.projectName", "irurueta-android-gl-cube")
...
mavenPublishing {
    ...
    coordinates("com.irurueta", "irurueta-android-gl-cube", libraryVersion)

    pom {
        name.set("irurueta-android-gl-cube")
        description.set("A view to display a 3D cube with transparent background")
        inceptionYear.set("2025")
        url.set("https://github.com/albertoirurueta/irurueta-android-gl-cube/")
        licenses {
            license {
                name.set("Apache License 2.0")
                url.set("https://github.com/albertoirurueta/irurueta-android-gl-cube/blob/main/LICENSE")
                distribution.set("https://github.com/albertoirurueta/irurueta-android-gl-cube/blob/main/LICENSE")
            }
        }
        developers {
            developer {
        ...
        scm {
            url.set("https://github.com/albertoirurueta/irurueta-android-gl-cube/")
            connection.set("scm:git:github.com/albertoirurueta/irurueta-android-gl-cube.git")
            developerConnection.set("scm:git:ssh://github.com/albertoirurueta/irurueta-android-gl-cube.git")
        }
    }
}
